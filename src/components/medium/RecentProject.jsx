...
<Link to="/projectdetails" className={`bg-[rgba(0,0,0,0.15)] rounded-sm relative group ${className}`}>
            ...
            <div className="overlay flex absolute top-0 left-0 w-full h-full before:absolute before:w-full before:h-full before:rounded-sm before:bg-linear-[180deg,rgba(0,0,0,0)_15%,black] before:opacity-20 opacity-0 group-hover:opacity-100 transition-all duration-500">
