    ...
    return(
        <div className="work mt-32 pt-44.5">
           <Container className="">
            ...
            <h1 className="font-segoe text-[475px] tracking-[0.1px] text-h1 uppercase w-full">Work</h1>
            <img className="absolute top-1/2 left-[46%] translate-x-[-40%] translate-y-[-10%]" src={workLogo} alt="" />
            </div>
