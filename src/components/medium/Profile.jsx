        ...
        <div className="img_text flex flex-col">
          ...
          <div className="img-content">
            <p className="max-w-[554px] font-segoe text-lg leading-7 tracking-[0.1px] text-bg pb-10">
              As a passionate UI/UX designer with a strong background in
              crafting intuitive and visually compelling digital experiences.
              With expertise in website design, mobile apps, SaaS platforms,
              branding, and interactive prototyping, I transform ideas into
              engaging user interfaces that drive results.
            </p>
            <div className="button flex gap-x-10 items-center">
              ...
              <div className="btn2 flex cursor-pointer gap-x-2.5 items-center group">
                <h1 className="font-segoe text-base leading-5 text-bg">
                  Download CV
                </h1>
